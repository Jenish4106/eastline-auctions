...
Route::middleware(['auth.admin-api'])->prefix('admin')->group(function () {
    ...
    Route::prefix('machinery')->group(function () {
        ...
        Route::post('/update-status', [AdminMachineryController::class, 'updateStatus']);
    ...
    Route::prefix('bidding')->group(function () {
        ...
        Route::post('/update-bid-status', [AdminBiddingController::class, 'updateBidStatus']);
    ...
    Route::prefix('orders')->group(function () {
        ...
        Route::prefix('tracking')->group(function () {
            ...
            Route::post('/delete', [OrderTrackingController::class, 'destroy']);
        });
    });
