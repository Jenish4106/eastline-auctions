...
$(function () {
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        return (
                            ...
                            "</div>" +
                            "</div>" +
                            '<a href="javascript:;" class="item-edit text-body"><i class="text-primary ti ti-edit"></i></a>'
                        );
                    },
                },
            ],
    ...
    if (dt_fixedheader_table.length) {
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        return (
                            ...
                            "</div>" +
                            "</div>" +
                            '<a href="javascript:;" class="btn btn-sm btn-icon item-edit"><i class="text-primary ti ti-edit"></i></a>'
                        );
                    },
                },
            ],
        ...
        if (window.Helpers.isNavbarFixed()) {
            ...
            new $.fn.dataTable.FixedHeader(dt_fixedheader).headerOffset(
                navHeight
            );
        } else {
