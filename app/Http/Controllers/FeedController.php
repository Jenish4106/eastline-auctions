...
class FeedController extends Controller
{
  ...
  public function catalogImage(Request $request, $id)
  {
    ...
    $svg = <<<SVG
      ...
      <g transform="translate(42, 992)">
        ...
        <text x="42" y="25" fill="#ffffff" font-size="17" class="ft">WARRANTY &amp; RETURN POLICY</text>
      </g>
      ...
      <g transform="translate(425, 996)">
        ...
        <text x="54" y="19" fill="#ffffff" font-size="17" class="ft">SHIPPING AVAILABLE</text>
      </g>
      ...
      <g transform="translate(795, 994)">
        ...
        <text x="36" y="22" fill="#ffffff" font-size="17" class="ft">SECURE BIDDING</text>
      </g>
      </svg>
      SVG;
  ...
  private function generateCatalogPngGd(
    ...
    // Time text
    $this->gdText($img, $timeLeftMain, 442, 844, 34, $cTitle, $font);
    $this->gdText($img, $timeLeftSub, 442, 874, 20, $cMuted, $font);
    ...
    if (file_exists($bidNowFile)) {
      ...
      if ($btnImg) {
        ...
        $drawH = 138;
        $drawW = 435;
        imagecopyresampled($img, $btnImg, 610, 782, 0, 0, $drawW, $drawH, $bw, $bh);
        imagedestroy($btnImg);
      }
    }
    ...
    $this->drawFooterShield($img, 42, 992, $cOrange);
    $this->gdText($img, 'WARRANTY & RETURN POLICY', 84, 1017, 17, $cWhite, $font);
    ...
    $this->gdText($img, 'SHIPPING AVAILABLE', 479, 1015, 17, $cWhite, $font);
    ...
    $this->gdText($img, 'SECURE BIDDING', 831, 1016, 17, $cWhite, $font);
    imagesetthickness($img, 1);
