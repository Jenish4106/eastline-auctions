...
<html>
<head>
    <title>Welcome to {{ \App\Models\Settings::get('company_name', 'Eastline Equipment Sales & Auctions') }}</title>
</head>
<body>
    <p>Hello {{ $user->first_name }} {{ $user->last_name }},</p>
    <p>Thank you for registering with {{ \App\Models\Settings::get('company_name', 'Eastline Equipment Sales & Auctions') }}!</p>
